...
// core/clientstate, which owns ~/.cortex/claude-code-state.json.
//
// Under core/observe because it serves OBSERVATION rather than authorization: nothing
...
// dividing line for this subtree — core's other packages exist to decide whether a
...
// one would sit beside this as core/observe/<agent>. When it lands, the shape and the

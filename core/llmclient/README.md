...
```go
import "github.com/rossoctl/cortex/core/llmclient"
...
The IBAC plugin (`core/plugins/ibac/`) is the in-tree consumer — see `judge.go` for a minimal `Judge` impl built on this package.

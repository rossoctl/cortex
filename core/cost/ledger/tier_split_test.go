...
// settle.NewRecord publishes one whenever the rate table resolved.
//
...
// and event.Event.Tiers is nil for it. Four zeros is how that is said: ApportionTiers

...
// invisible without cache tokens, which is exactly why the 2026-09-11 validation in costing.go —
...
func TestSettle_CacheBlindGuardNeedsAModelledFigure(t *testing.T) {
	...
	if !got.Priced || got.CostUSD != 0.0185 || got.Source != costevent.SourceGatewayHeader {

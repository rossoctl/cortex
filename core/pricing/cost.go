...
const (
	...
	// MaxPlausibleTokens below so core/usage derives the same bound instead of restating it.
...
//
// It exists because core/usage refuses an implausible token report and needs the same

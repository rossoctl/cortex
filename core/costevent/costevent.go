...
// including the trimmed "lite" images that exclude the plugin entirely. core/pricing
...
// authbridge-proxy price traffic, and abctl reaches it through core/usage and core/config.
package costevent
...
type Event struct {
	...
	// "discovered", "bundled"). See core/pricing.Provenance.
	//

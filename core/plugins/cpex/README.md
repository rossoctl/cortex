...
`go test ./core/plugins/cpex/...` runs with `CGO_ENABLED=0`.
...
listeners then choose the wire shape (`core/listener/httpx/render.go`):
...
- `demos/hr-cpex` — end-to-end demo with Bob, Eve, and Alice personas
